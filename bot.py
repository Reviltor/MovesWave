    ...
    try:
        with sqlite3.connect(DB_NAME) as conn:
            ...
            test_data = [
                ...
                ("Бесстыжие", "9538", "Комедийная драма о многодетной семье Галлагеров...", "images/besstizhie.jpg"),
                ...
                ("Во все тяжкие", "0357", "Один из самых культовых сериалов...", "images/vosetyazhkie.jpg"),
                ("Два холма", "2015", "Российский фантастический сериал...", "images/dvaholma.jpg"),
                ("Урок", "4100", "Остросоциальный драматический сериал...", "images/urok.jpg"),
                ("Жизнь по вызову", "9340", "Сериал о девушках, работающих в сфере эскорта...", "images/zhiznpovizovu.jpg"),
