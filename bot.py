    ...
    try:
        with sqlite3.connect(DB_NAME) as conn:
            ...
            test_data = [
                ...
                ("Игра в кальмара 3", "0478", "Игра в кальмара 3 сезон — продолжение дорамы-триллера о простой детской игре, из которой люди выбывают по-настоящему: проигравший погибает самым страшным образом.", "images/igravkalmara.jpg"),
                ("Бойцовский клуб", "8057", "Сотрудник страховой компании страдает хронической бессонницей и отчаянно пытается вырваться из мучительно скучной жизни. Однажды в очередной командировке он встречает некоего Тайлера Дёрдена — харизматического торговца мылом с извращенной философией.", "images/fight_club.jpg"),
                ("Во всем виноваты звезды", "1041", "Хэйзел больна раком. Несмотря на то, что болезнь временно отступила, девушка не чувствует ни капли радости. Она ходит в группу поддержки, где однажды знакомится с Огастусом Уотерсом и моментально влюбляется в него.", "images/zvezdi.jfif")
            ]
